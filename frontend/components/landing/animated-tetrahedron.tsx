  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      points.forEach((point) => {
        ...
        // Use electric blue color scheme
        const blueValue = Math.floor(91 + (point.z + 1.5) * 55);
        ctx.fillStyle = `rgba(${blueValue}, ${Math.floor(157 + (point.z + 1.5) * 33)}, 255, ${Math.min(alpha, 0.9)})`;
